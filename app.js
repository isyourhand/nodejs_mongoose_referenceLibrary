...
app.post(
    '/webhook-checkout',
    express.raw({ type: 'application/json' }), // This is a built-in middleware function in Express. It parses incoming request payloads into a Buffer and is based on body-parser.
