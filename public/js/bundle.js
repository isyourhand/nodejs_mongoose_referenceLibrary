...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiYmlnZHN5IiwiYSI6ImNsa2E4a3NoaTAzeXYzZm54cHJ1OW45aTcifQ.xPCN4GxDO_RjOgDrNXicJA';
...
exports.signup = exports.sendResetPasswordEmail = exports.resetPassword = exports.logout = exports.login = void 0;
...
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; } // Listening for the submit event that the browser will fire off whenever a user clicks on the submit button on the form.
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 7:
          ...
          (0, _alerts.showAlert)('error', 'logout error! please try again.');
        case 11:
        case "end":
...
var sendResetPasswordEmail = /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(email, button) {
    var res;
      ...
      while (1) switch (_context4.prev = _context4.next) {
        ...
        case 4:
          ...
          if (res.data.status === 'success') {
            ...
            (0, _alerts.showAlert)('success', 'send successfully');
          }
          _context4.next = 13;
          break;
        case 8:
  ...
  return function sendResetPasswordEmail(_x4, _x5) {
    ...
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        ...
        case 4:
          res = _context5.sent;
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', 'Reset successfully');
            window.setTimeout(function () {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 4:
          res = _context.sent;
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', "".concat(type.toUpperCase(), " updated success!"));
            window.setTimeout(function () {
              location.assign('/me');
            }, 1000);
          }
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }
var stripe = Stripe('pk_test_51NXenQAw3ikfz8p2nABpDyxhSrVmse2XiBMTABVU8gi2cgTIm71CeWXFMjQtRzLWP3blUm66HmfzTpvUq5bjEftq00YfBDqiOR');
...
var resetPasswprdForm = document.querySelector('.form--resetRassword');
var signupForm = document.querySelector('.form--signup');
var loginForm = document.querySelector('.form--login');
var logOutBtn = document.querySelector('.nav__el--logout');
var userUpdateForm = document.querySelector('.form-user-data');
var passUpdataForm = document.querySelector('.form-user-password');
var bookBtn = document.getElementById('book-tour');
var ifResetPassBtn = document.getElementById('resetPass');
...
if (emailForm) {
  ...
  emailForm.addEventListener('submit', function (e) {
    ...
    console.log(email);
    (0, _auth.sendResetPasswordEmail)(email, send);
  });
}
if (resetPasswprdForm) {
  resetPasswprdForm.addEventListener('submit', function (e) {
    e.preventDefault();
...
if (userUpdateForm) {
  userUpdateForm.addEventListener('submit', function (el) {
    el.preventDefault();
...
if (passUpdataForm) {
  passUpdataForm.addEventListener('submit', /*#__PURE__*/function () {
...
if (bookBtn) bookBtn.addEventListener('click', function (e) {
  ...
  var tourId = e.target.dataset.tourId; // Same effect with above.
  (0, _stripe.bookTour)(tourId);
});
if (ifResetPassBtn) {
  ifResetPassBtn.addEventListener('click', function (e) {
